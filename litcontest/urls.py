...
from .views import SignUpView, ContestCreateView, ContestUpdateView, ContestCoordinatorUpdateView, ContestListView, ContestDetailView, StoryDetailView, StoryCreateView, StoryUpdateView, RulesView, AboutView
...
urlpatterns = [
    ...
    path("<int:pk>/voting", views.generate_zip, name="generate_zip"),
    path("<int:pk>/results", views.generate_zip, name="generate_zip"),
    path("<int:contest_id>/download", views.generate_zip, name="generate_zip"),
    path("<int:contest_id>/final/download", views.generate_zip_final, name="generate_zip_final"),
    path("add/", ContestCreateView.as_view(), name="contest-add"),
    path("<int:pk>/edit", ContestUpdateView.as_view(), name="contest-update"),
    path("<int:pk>/theme", ContestCoordinatorUpdateView.as_view(), name="contest-theme"),
    path("text/<int:pk>", StoryDetailView.as_view(), name="story-detail"),
